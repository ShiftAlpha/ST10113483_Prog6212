...
using Module = ST101113483_Prog6212.Models.Module;
...
namespace Study_Tracker.Controllers
{
    public class ModulesController : Controller
    {
        ...
        private readonly ST101113483_Prog6212Context _context;

        public ModulesController(ST101113483_Prog6212Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'ST101113483_Prog6212Context.Module'  is null.");
            }
            var @module = await _context.Module.FindAsync(id);
            if (@module != null)
            {
